...
def train(X_train, y_train):
  model = RandomForestClassifier(bootstrap=False, max_depth=20, min_samples_leaf=2, min_samples_split=2, n_estimators=300, random_state=42)
...
print('Resultados de Treino HOG x PCA x Random Forest')
predict_and_evaluate(model, X_train_concat, y_train)
print('Resultados de Teste HOG x PCA x Random Forest')
